...
<!-- mcp-name: com.hasdata/duckduckgo -->
...
The free tier is **1,000 credits every month with no card**, which is 100 searches. It renews with the billing cycle, so a low-volume agent runs on the free tier indefinitely.

Paid plans start at **$59 a month** for 200,000 credits, which is 20,000 searches. The unit price falls with volume, from **$2.95 per 1,000 searches** on the entry plan to **$1.19** on Basic and **$0.83** across the Growth tiers. Current numbers live on the [pricing page](https://hasdata.com/prices?utm_source=github&utm_medium=syndication&utm_campaign=duckduckgo-mcp).
